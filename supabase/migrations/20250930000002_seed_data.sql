...
INSERT INTO campaigns (
  ...
  (
    ...
    '맛있는 카페 신메뉴 체험단 모집',
    '카페',
    'https://via.placeholder.com/800x600.png?text=Cafe+Thumbnail',
    '["https://via.placeholder.com/800x600.png?text=Image1","https://via.placeholder.com/800x600.png?text=Image2"]'::jsonb,
...
INSERT INTO campaigns (
  ...
  (
    ...
    '프리미엄 뷰티샵 피부관리 체험단',
    '뷰티',
    'https://via.placeholder.com/800x600.png?text=Beauty+Thumbnail',
    '["https://via.placeholder.com/800x600.png?text=BeautyImage1"]'::jsonb,
...
INSERT INTO campaigns (
  ...
  (
    ...
    '맛있는 카페 브런치 메뉴 체험단',
    '카페',
    'https://via.placeholder.com/800x600.png?text=Brunch+Thumbnail',
    '[]'::jsonb,
